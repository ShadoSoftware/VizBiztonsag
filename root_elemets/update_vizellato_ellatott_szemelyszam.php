<?php
$vizellato_ellatott_szemelyszam=$_POST["ellatott_szemelyszam"];
$id=$_POST["id"];

	include("config.php");

	$sql_text = "UPDATE vizellat_alap SET `ellatott_szemelyek_szama`='$vizellato_ellatott_szemelyszam' WHERE ID = '$id'";

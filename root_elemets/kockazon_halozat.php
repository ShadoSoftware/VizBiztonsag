...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
			<legend><h1>Hálózat kockázatainak azonosítása</h1></legend>
<form action="" method="POST">			
								...
								<label class="col-2 " style="font-size: 1.5em">Vízellátási egység:</label>
									<div class="col-10">
										...
										header('Content-Type: text/html; charset=utf-8');
											include("config.php");
											$sql_text= 'SELECT * FROM vizellatas_egyseg WHERE ID=5 OR ID=6 OR ID=7';
			...
			<div class="form-group">
									<div class="col-sm-12 text-right">
									<hr style="border:1px dashed #dddddd;">
										<button type="button" class="btn btn-primary button-block" id="ment_halozat">
...
<script>
	...
	var jav_eljaras;
	var kapcs_monit;
	document.getElementById('ment_halozat').addEventListener('click', ment);
	function ment(){

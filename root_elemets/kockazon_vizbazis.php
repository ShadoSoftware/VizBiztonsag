...
<body>
		...
		<div class="row">
			<div class="col-lg-12">
			<legend><h1>Vízbázis, víznyerés kockázatainak azonosítása</h1></legend>
<form action="" method="POST">			
			...
			<div class="form-group row">
								<label class="col-2 " style="font-size: 1.5em">Vízellátási egység:</label>
									<div class="col-10">
										...
										<select class="form-control" id="vizellat_egyseg" name="vizellat_egyseg" onchange="console.log(this.value)">
										<option>Válsszon vízellátási egységet!</option>
										<?php
										header('Content-Type: text/html; charset=utf-8');
											include("config.php");
											
											$sql_text= "SELECT * FROM vizellatas_egyseg WHERE ID=1 OR ID=2 OR ID=3 OR ID=4";
											...
											<input type="hidden" id="selected_vizellat_egyseg" name="selected_vizellat_egyseg" value="">
									</div>
								</div>
			...
			<div class="form-group row">
								<label class="col-2 " style="font-size: 1.5em">Beavatkozás, intézkedés:</label>
									<div class="col-10">
										<textarea class="form-control" id="beavatkozas2" name="beavatkozas2" maxlength="500" rows="12"></textarea>
									</div>
								</div>	
			...
			<div class="form-group">
									<div class="col-sm-12 text-right">
									<hr style="border:1px dashed #dddddd;">
										<button type="button" class="btn btn-primary button-block" id="ment1">
...
<script>
	...
	var jav_eljaras;
	var kapcs_monit;
	document.getElementById('ment1').addEventListener('click', ment);
	function ment(){
		var vizellat_egyseg_object=document.getElementById('vizellat_egyseg'); 
		var index = vizellat_egyseg_object.selectedIndex;
		var value =  vizellat_egyseg_object.options[index].value;
		var content = vizellat_egyseg_object.options[index].text;
		vizellat_egyseg_ID=content;
		console.log(vizellat_egyseg_ID);
		...
		jav_eljaras=document.getElementById('beavatkozas2').value;
		console.log(jav_eljaras);
		kapcs_monit=document.getElementById('monitoring1').value;
		console.log(kapcs_monit);
		$.ajax(
						  {url:"insert_kock_vizbazis.php", 
						  type:'POST',
						  dataType: 'json',
						  data: {vizellat_egyseg_ID: vizellat_egyseg_ID,
								veszely_tipus: veszely_tipus,
